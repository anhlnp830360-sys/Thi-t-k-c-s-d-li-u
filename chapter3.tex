...
\begin{center}
\small
\begin{longtable}{|c|p{3.2cm}|p{2.8cm}|p{3.2cm}|p{3.8cm}|}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item $(\text{user\_id\_fk}, \text{role\_id\_fk}) \rightarrow \text{user\_role\_id}$ (Do khóa ghép UNIQUE)
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item $\text{server\_name} \rightarrow \{\text{server\_id}, \text{ip\_address}, \text{operating\_system}, \text{status}, \text{rack\_id\_fk}\}$ (Do UNIQUE)
        \item $\text{ip\_address} \rightarrow \{\text{server\_id}, \text{server\_name}, \text{operating\_system}, \text{status}, \text{rack\_id\_fk}\}$ (Do UNIQUE)
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item $\text{server\_id\_fk} \rightarrow \{\text{warranty\_id}, \text{provider}, \text{warranty\_start}, \text{warranty\_end}, \text{status}\}$ (Do UNIQUE)
    \end{itemize}

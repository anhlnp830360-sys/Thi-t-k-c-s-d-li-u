...
\caption{Danh sách chức năng và ý nghĩa của các thực thể} \label{tab:thuc_the_Mo_ta} \\
\hline
\textbf{Thực thể} & \textbf{Chức năng} & \textbf{Ý nghĩa} \\ \hline
\endfirsthead

\multicolumn{3}{c}{\small\textit{(Bảng \thetable{} -- tiếp theo)}} \\
\hline
\textbf{Thực thể} & \textbf{Chức năng} & \textbf{Ý nghĩa} \\ \hline
\endhead
...
\subsection{ROLE}
\begin{center}
\begin{longtable}{|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}p{6.5cm}|>{\raggedright\arraybackslash}p{4.5cm}|}
\hline
...
\begin{center}
\begin{longtable}{|>{\raggedright\arraybackslash}p{4.5cm}|>{\raggedright\arraybackslash}p{5.5cm}|>{\raggedright\arraybackslash}p{4.5cm}|}
\hline
\textbf{Thuộc tính} & \textbf{Mô tả} & \textbf{Constraint} \\ \hline
\endhead
...
\begin{center}
\small
\begin{longtable}{|c|>{\raggedright\arraybackslash}p{2.5cm}|c|>{\raggedright\arraybackslash}p{2.8cm}|>{\raggedright\arraybackslash}p{5.7cm}|}
\caption{Danh sách mối quan hệ giữa các thực thể} \label{tab:moi_quan_he} \\
\hline
\textbf{STT} & \textbf{Thực thể 1} & \textbf{Cardinality} & \textbf{Thực thể 2} & \textbf{Mô tả mối quan hệ} \\ \hline
\endfirsthead

\multicolumn{5}{c}{\small\textit{(Bảng \thetable{} -- tiếp theo)}} \\
\hline
\textbf{STT} & \textbf{Thực thể 1} & \textbf{Cardinality} & \textbf{Thực thể 2} & \textbf{Mô tả mối quan hệ} \\ \hline
\endhead
...
\begin{center}
\begin{longtable}{|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}p{11.0cm}|}
\hline
